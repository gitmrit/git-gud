...
export const GithubIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" {...props}>
...
export const GitBranchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
    <path d="M9.5 3.25a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-2.25.75a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z"></path>
    <path d="M6.25 5.5A1.75 1.75 0 0 0 4.5 7.25v3.25a.75.75 0 0 0 1.5 0V8a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-1a.75.75 0 0 0 0 1.5h1a2.25 2.25 0 0 0 2.25-2.25V7.25A1.75 1.75 0 0 0 9.75 5.5h-3.5Z"></path>
  </svg>
);
...
export const RocketLaunchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 2.18a14.98 14.98 0 00-2.18 6.16m5.84 2.58v4.8m-5.84-4.8h4.8m-4.8 0l-2.18-2.18m2.18 2.18l2.18 2.18m0 0l2.18-2.18m-2.18 2.18v-4.8m0 4.8h4.8" />
  </svg>
);
